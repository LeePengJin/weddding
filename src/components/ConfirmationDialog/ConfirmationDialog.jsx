...
const ConfirmationDialog = ({ open, onClose, onConfirm, title, description, confirmText = 'Confirm', cancelText = 'Cancel' }) => {
  ...
  return (
    <Box className="confirmation-dialog-overlay" onClick={onClose}>
      <Box className="confirmation-dialog-card" onClick={(e) => e.stopPropagation()}>
        <button className="confirmation-dialog-exit" onClick={onClose}>
        ...
        <Box className="confirmation-dialog-button-wrapper">
          ...
          <Button className="confirmation-dialog-button primary" onClick={onConfirm}>
            {confirmText}
          </Button>
        </Box>
      </Box>
